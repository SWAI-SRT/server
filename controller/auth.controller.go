...
func NewAuthController(authService *service.AuthService, imageService *service.ImageService) *AuthController {
	return &AuthController{authService: authService, imageService: imageService}
}
